...
class AdvertisementsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.page.advertisement.index', compact(['homepage_section_banner_one','product_page_banner_section','homepage_section_banner_two','homepage_section_banner_three']));
    }
