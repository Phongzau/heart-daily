        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="product-tab-reviews" data-toggle="tab" href="#product-reviews-content"
                    role="tab" aria-controls="product-reviews-content" aria-selected="false">{{ $countReviews }} Reviews</a>
            </li>
        </ul>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="product-reviews-content" role="tabpanel"
                ...
                <div class="product-reviews-content">
                    <h3 class="reviews-title">{{$product->name}}</h3>
                    <div id="reviewSection">
                        @foreach($reviews as $item)
                        <div class="comment-list">
                            <div class="comments">
                                <figure class="img-thumbnail">
                                    <img src="{{ Storage::url(optional($item->user)->image) }}" alt="author" width="80" height="80">
                                </figure>
                    ...
                    <a href="{{ route('product.detail', ['slug' => $product->slug]) }}">
                        ...
                        <img src="
                                @if (isset($product->ProductImageGalleries[0]->image)) 
                                    {{ Storage::url($product->ProductImageGalleries[0]->image) }}
                                @else
...
<script>
    ...
    $(document).ready(function() {
        ...
        toastr.error("Bạn phải chọn mức đánh giá từ 1 đến 5.");
        return;
    }
            ...
            function renderReviews(reviews) {
                ...
                $('.count-reviews').text(reviews.total + ` Reviews`);
                reviewSection.empty(); // Xóa các bình luận cũ
                ...
                reviews.data.forEach(review => {
                    ...
                    <div class="post-author">
                        <figure>
                            <a href="#">
                                <img src="${review.user.profile_image_url}" alt="author">
                            </a>
                        </figure>
                ...
                if (reviews.total > 0) {
                    $('.toolbox-item').html(`
                    Hiển thị ${reviews.from}-${reviews.to} của ${reviews.total} bình luận
                `);
                } else {
                ...
                if (reviews.last_page > 1) {
                    ...
                    if (reviews.current_page > 1) {
                        paginationHtml +=
                            `<li class="page-item"><a class="page-link page-link-btn" href="${reviews.prev_page_url}"><i class="icon-angle-left"></i></a></li>`;
                    } else {
                        paginationHtml +=
                    ...
                    if (reviews.current_page < reviews.last_page) {
                        paginationHtml +=
                            `<li class="page-item"><a class="page-link page-link-btn" href="${reviews.next_page_url}"><i class="icon-angle-right"></i></a></li>`;
                    } else {
                        paginationHtml +=
