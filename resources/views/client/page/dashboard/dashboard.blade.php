        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="withdrawModalLabel">Tạo Lệnh Rút Điểm
                    (100.000{{ $generalSettings->currency_icon }} ~ 1.000.000{{ $generalSettings->currency_icon }})</h5>
                <span class="close">&times;</span>
            </div>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#continueStep', function() {
                ...
                if (!amount) {
                    ...
                    errors.push('Số tiền tối thiếu là 100.000{{ $generalSettings->currency_icon }}!');
                } else if (amount > 1000000) {
                    errors.push('Số tiền tối đa là 1.000.000{{ $generalSettings->currency_icon }}!');
                }
                if (!bankAccount) {
