                    ...
                    <div class="row">
                        <div class="col-md-6 product-single-gallery">
                                ...
                                <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                                    <div class="product-item">
                                        <img class="product-single-image"
                                            src="{{ asset('frontend/assets/images/products/zoom/product-1-big.jpg') }}"
                                            data-zoom-image="{{ asset('frontend/assets/images/products/zoom/product-1-big.jpg') }}"
                                            width="468" height="468" alt="product" />
                                    </div>
                                    <div class="product-item">
                                        <img class="product-single-image"
                                            src="{{ asset('frontend/assets/images/products/zoom/product-2-big.jpg') }}"
                                            data-zoom-image="{{ asset('frontend/assets/images/products/zoom/product-2-big.jpg') }}"
                                            width="468" height="468" alt="product" />
                                    </div>
                                    <div class="product-item">
                                        <img class="product-single-image"
                                            src="{{ asset('frontend/assets/images/products/zoom/product-3-big.jpg') }}"
                                            data-zoom-image="{{ asset('frontend/assets/images/products/zoom/product-3-big.jpg') }}"
                                            width="468" height="468" alt="product" />
                                    </div>
                                    <div class="product-item">
                                        <img class="product-single-image"
                                            src="{{ asset('frontend/assets/images/products/zoom/product-4-big.jpg') }}"
                                            data-zoom-image="{{ asset('frontend/assets/images/products/zoom/product-4-big.jpg') }}"
                                            width="468" height="468" alt="product" />
                                    </div>
                                    <div class="product-item">
                                        <img class="product-single-image"
                                            src="{{ asset('frontend/assets/images/products/zoom/product-5-big.jpg') }}"
                                            data-zoom-image="{{ asset('frontend/assets/images/products/zoom/product-5-big.jpg') }}"
                                            width="468" height="468" alt="product" />
                                    </div>
                                </div>
                            ...
                            <div class="prod-thumbnail owl-dots">
                                ...
                                <div class="owl-dot">
                                    <img src="{{ asset('frontend/assets/images/products/zoom/product-5.jpg') }}"
                                        width="110" height="110" alt="product-thumbnail" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade show active" id="product-desc-content" role="tabpanel"
                            ...
                            <div class="product-desc-content">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                                    ...
                                    do, quis nostrud exercitation ullamco
                                ...
                                <div class="comment-list">
                                    <div class="comments">
                                        <figure class="img-thumbnail">
                                            <img src="{{ asset('frontend/assets/images/blog/author.jpg') }}"
                    ...
                    <div class="widget">
                        <div class="maga-sale-container custom-maga-sale-container">
                            <figure class="mega-image">
                                <img src="{{ asset('frontend/assets/images/banners/banner-sidebar-bg.jpg') }}"
                                        ...
                                        <figure>
                                            <a href="product.html">
                                                <img src="{{ asset('frontend/assets/images/products/small/product-4.jpg') }}"
                                                    width="75" height="75" alt="product-widget" />
        ...
        <div class="products-section pt-0">
            ...
            <div class="products-slider owl-carousel owl-theme dots-top dots-small">
                <div class="product-default">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('frontend/assets/images/products/product-1.jpg') }}" width="280"
                                height="280" alt="product">
                            <img src="{{ asset('frontend/assets/images/products/product-1-2.jpg') }}" width="280"
                                height="280" alt="product">
                        </a>
                ...
                <div class="product-default">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('frontend/assets/images/products/product-3.jpg') }}" width="280"
                                height="280" alt="product">
                            <img src="{{ asset('frontend/assets/images/products/product-3-2.jpg') }}" width="280"
                                height="280" alt="product">
                        </a>
                        <div class="label-group">
                            <div class="product-label label-hot">HOT</div>
                ...
                <div class="product-default">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('frontend/assets/images/products/product-7.jpg') }}" width="280"
                                height="280" alt="product">
                            <img src="{{ asset('frontend/assets/images/products/product-7-2.jpg') }}" width="280"
                                height="280" alt="product">
                        </a>
                        <div class="label-group">
                            <div class="product-label label-hot">HOT</div>
                ...
                <div class="product-default">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('frontend/assets/images/products/product-6.jpg') }}" width="280"
                                height="280" alt="product">
                            <img src="{{ asset('frontend/assets/images/products/product-6-2.jpg') }}" width="280"
                                height="280" alt="product">
                        </a>
                        <div class="label-group">
                            <div class="product-label label-hot">HOT</div>
                ...
                <div class="product-default">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('frontend/assets/images/products/product-4.jpg') }}" width="280"
                                height="280" alt="product">
                            <img src="{{ asset('frontend/assets/images/products/product-4-2.jpg') }}" width="280"
                                height="280" alt="product">
                        </a>
                        <div class="label-group">
                            <div class="product-label label-hot">HOT</div>
        ...
        <div class="product-widgets-container row pb-2">
            <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('frontend/assets/images/products/small/product-1.jpg') }}" width="74"
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('frontend/assets/images/products/small/product-2.jpg') }}" width="74"
                                height="74" alt="product">
                            <img src="{{ asset('frontend/assets/images/products/small/product-2-2.jpg') }}"
                                width="74" height="74" alt="product">
                        </a>
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('frontend/assets/images/products/small/product-3.jpg') }}" width="74"
                                height="74" alt="product">
                            <img src="{{ asset('frontend/assets/images/products/small/product-3-2.jpg') }}"
                                width="74" height="74" alt="product">
                        </a>
            ...
            <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('frontend/assets/images/products/small/product-4.jpg') }}" width="74"
                                height="74" alt="product">
                            <img src="{{ asset('frontend/assets/images/products/small/product-4-2.jpg') }}"
                                width="74" height="74" alt="product">
                        </a>
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('frontend/assets/images/products/small/product-5.jpg') }}" width="74"
                                height="74" alt="product">
                            <img src="{{ asset('frontend/assets/images/products/small/product-5-2.jpg') }}"
                                width="74" height="74" alt="product">
                        </a>
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('frontend/assets/images/products/small/product-6.jpg') }}" width="74"
                                height="74" alt="product">
                            <img src="{{ asset('frontend/assets/images/products/small/product-6-2.jpg') }}"
                                width="74" height="74" alt="product">
                        </a>
            ...
            <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('frontend/assets/images/products/small/product-7.jpg') }}" width="74"
                                height="74" alt="product">
                            <img src="{{ asset('frontend/assets/images/products/small/product-7-2.jpg') }}"
                                width="74" height="74" alt="product">
                        </a>
                    </figure>
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('frontend/assets/images/products/small/product-8.jpg') }}" width="74"
                                height="74" alt="product">
                            <img src="{{ asset('frontend/assets/images/products/small/product-8-2.jpg') }}"
                                width="74" height="74" alt="product">
                        </a>
                    </figure>
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('frontend/assets/images/products/small/product-9.jpg') }}" width="74"
                                height="74" alt="product">
                            <img src="{{ asset('frontend/assets/images/products/small/product-9-2.jpg') }}"
                                width="74" height="74" alt="product">
                        </a>
                    </figure>
            ...
            <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('frontend/assets/images/products/small/product-10.jpg') }}" width="74"
                                height="74" alt="product">
                            <img src="{{ asset('frontend/assets/images/products/small/product-10-2.jpg') }}"
                                width="74" height="74" alt="product">
                        </a>
                    </figure>
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('frontend/assets/images/products/small/product-11.jpg') }}" width="74"
                                height="74" alt="product">
                            <img src="{{ asset('frontend/assets/images/products/small/product-11-2.jpg') }}"
                                width="74" height="74" alt="product">
                        </a>
                    </figure>
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('frontend/assets/images/products/small/product-12.jpg') }}" width="74"
                                height="74" alt="product">
                            <img src="{{ asset('frontend/assets/images/products/small/product-12-2.jpg') }}"
                                width="74" height="74" alt="product">
                        </a>
                    </figure>
