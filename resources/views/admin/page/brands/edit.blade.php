...
@section('title')
    {{ $generalSettings->site_name }} || Chỉnh sửa thương hiệu
@endsection
                                                    ...
                                                    <div class="form-group">
                                                        <div style="display: flex; gap: 10px; margin: 10px;"
                                                            ...
                                                            <label for="imageUpload"
                                                                style="padding: 0.5rem 1rem; margin-bottom: unset !important; border-radius: 10px; background-color: black; color: #fff; display: flex; justify-content: center; align-items: center">Tải ảnh lên...</label>
