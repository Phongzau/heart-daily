    ...
    <div class="container account-container custom-account-container">
        <div class="row">
            ...
            <div class="col-lg-9 order-lg-last order-1 tab-content">
                @include('frontend.dashboard.sections.dashboard')

                @include('frontend.dashboard.sections.order')

                @include('frontend.dashboard.sections.download')

                @include('frontend.dashboard.sections.address')

                @include('frontend.dashboard.sections.account-details')

                @include('frontend.dashboard.sections.billing-address')

                @include('frontend.dashboard.sections.shipping-address')
            </div><!-- End .tab-content -->
        </div><!-- End .row -->
    </div><!-- End .container -->
